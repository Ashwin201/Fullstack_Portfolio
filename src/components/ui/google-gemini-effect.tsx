...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky top-20  md:top-[120px]", className)}>
            ...
            <p className="text-xs  md:text-xl font-medium text-center text-gray-600 dark:text-gray-500 mt-8 xl:mt-8 px-4  sm:px-10 md:px-16 lg:px-28 mx-auto mb-14 block ">
