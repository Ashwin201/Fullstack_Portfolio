    ...
    return (
        <section className="text-gray-600 body-font  ">
            <div className=" md:px-5  w-full">
                ...
                <div className=" grid grid-cols-8 sm:flex-row justify-between items-start  text-center gap-8 sm:gap-5 ">
                    ...
                    <div className='col-span-8 md:col-span-4  sm:mt-0 flex flex-col items-center justify-center gap-3 rounded-md  order-3 md:order-2 '>
                        <div className=" w-full relative md:hidden lg:block  ">
                            ...
                            <AnimateOnVisible animation={"slideUp"} duration={0.9} className="relative  h-full overflow-hidden rounded-2xl flex flex-col justify-start md:justify-center items-start md:items-center md:mt-0 mt-6">


                                <div className="text-3xl text-start md:text-center mb-3  font-bold    theme-gradient-text ">
                                    Expertise I Have
                                </div>
                                <div className=" text-start md:text-center mx-auto font-medium text-base dark:text-gray-300 text-gray-600">
                                    Proficient in building
                                    <FlipWords words={words} /> <br />
                                    websites with expertise in full-stack development using modern technologies like the  React.js, Next.js, Tailwind CSS, Node.js, Express.js, MongoDB etc.  </div>
