...
const SidebarContent = () => {
    ...
    return (
        <div className=' flex flex-col items-center justify-center gap-5'>
            ...
            <AnimateOnVisible animation={"slideUp"} duration={0.9} className=" text-3xl font-bold text-center  bg-clip-text text-transparent bg-gradient-to-b from-neutral-500 to-neutral-700">Ashmin Sharma</AnimateOnVisible>
